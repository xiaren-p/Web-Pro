              ...
              <template #label>
                <div class="more-attrs__label">
                  <p class="more-attrs__label-zh">
                    <span v-if="field.required" class="more-attrs__label-star">*</span>
                    {{ field.label[1] }}
                  </p>
                  <p class="more-attrs__label-en">{{ field.label[0] }}</p>
                </div>
              </template>
              <DynamicField
            ...
            >
              <template #label>
                <div class="more-attrs__label">
                  ...
                  <p class="more-attrs__label-en">{{ field.label[1] }}</p>
                </div>
              </template>
              <DynamicField
 ...
 * 3. otherFields（未归入 basic/quote/image/desc 的字段）平铺渲染
 * 4. 工具栏：仅必填过滤 + 字段名搜索
