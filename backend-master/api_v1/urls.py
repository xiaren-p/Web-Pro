...
urlpatterns = [
    ...
    path('ads/campaigns/batch-adjust-state', views.AdCampaignViewSet.as_view({'post': 'batch_adjust_state', }), name='ads-campaigns-batch-adjust-state'),
    path('ads/campaigns/batch-adjust-budget', views.AdCampaignViewSet.as_view({'post': 'batch_adjust_budget', }), name='ads-campaigns-batch-adjust-budget'),
    ...
    path('ads/auto-targeting/batch-adjust-state', views.AutoTargetingViewSet.as_view({'post': 'batch_adjust_state', }), name='ads-auto-targeting-batch-adjust-state'),
    path('ads/auto-targeting/batch-adjust-bid', views.AutoTargetingViewSet.as_view({'post': 'batch_adjust_bid', }), name='ads-auto-targeting-batch-adjust-bid'),
    ...
    path('ads/product-targeting/batch-adjust-state', views.AutoTargetingViewSet.as_view({'post': 'batch_adjust_state', }), name='ads-product-targeting-batch-adjust-state'),
    path('ads/product-targeting/batch-adjust-bid', views.AutoTargetingViewSet.as_view({'post': 'batch_adjust_bid', }), name='ads-product-targeting-batch-adjust-bid'),
    ...
    path('ads/keywords/batch-adjust-state', views.KeywordViewSet.as_view({'post': 'batch_adjust_state', }), name='ads-keywords-batch-adjust-state'),
    path('ads/keywords/batch-adjust-bid', views.KeywordViewSet.as_view({'post': 'batch_adjust_bid', }), name='ads-keywords-batch-adjust-bid'),
    ...
    path('ads/time-pricing-strategy/shops', views.TimePricingStrategyViewSet.as_view({'get': 'shops'}), name='ads-time-pricing-strategy-shops'),
    path('ads/time-pricing-strategy/managers', views.TimePricingStrategyViewSet.as_view({'get': 'managers'}), name='ads-time-pricing-strategy-managers'),
    path('ads/time-pricing-strategy/assorts', views.TimePricingStrategyViewSet.as_view({'get': 'assorts'}), name='ads-time-pricing-strategy-assorts'),
