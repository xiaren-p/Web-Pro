...
from apps.ads.sp.services.ad_optimization.optimization_executor.executor_campaign import (
    execute_campaign_rules,
)
from apps.ads.sp.services.ad_optimization.optimization_executor.executor_keyword import (
    execute_keyword_rules,
)
from apps.ads.sp.services.ad_optimization.optimization_executor.executor_product_targeting import (
    execute_product_targeting_rules,
)
from apps.ads.sp.services.ad_optimization.optimization_executor.executor_targeting import (
    execute_targeting_rules,
)
from apps.ads.sp.services.ad_optimization.optimization_executor.placeholder_targets import (
