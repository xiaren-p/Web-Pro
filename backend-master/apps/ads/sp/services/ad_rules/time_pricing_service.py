...
from apps.ads.sp.models.sp_bid_adjustment import SpBidAdjustment
from apps.ads.sp.services.ad_rules.time_pricing_calculator import (
    MAX_ERROR_COUNT,
    build_item_map,
    calc_new_bid,
...
from apps.ads.sp.services.ad_rules.time_pricing_shared import (
    UTC_TZ,
...
def _do_start(
    ...
    """
    from apps.ads.sp.services.ad_rules.time_pricing_calculator import append_start_adjustment
...
def _do_callback(
    ...
    """
    from apps.ads.sp.services.ad_rules.time_pricing_calculator import append_callback_adjustment
