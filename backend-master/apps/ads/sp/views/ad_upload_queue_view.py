...
from apps.ads.sp.serializers.ad_upload_queue_serializer import (
    AdBulkDeleteSerializer,
    AdUploadQueueSerializer,
)
from apps.ads.sp.services.ad_upload_queue_service import bulk_delete_queue, parse_and_create_queue
