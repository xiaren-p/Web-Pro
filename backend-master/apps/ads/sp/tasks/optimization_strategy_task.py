...
from apps.ads.sp.services.ad_optimization.optimization_strategy_service import (
...
@shared_task(
    bind=True,
    name="apps.ads.sp.tasks.optimization_strategy_task.run_optimization_strategy_task",
    max_retries=0,
