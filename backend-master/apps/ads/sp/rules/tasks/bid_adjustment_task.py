...
from apps.ads.sp.rules.services.bid_adjustment_executor import execute_bid_adjustment
...
@shared_task(
    bind=True,
    name="apps.ads.sp.rules.tasks.bid_adjustment_task.run_bid_adjustment_task",
    max_retries=0,
    soft_time_limit=840,
    time_limit=900,
    acks_late=True,
