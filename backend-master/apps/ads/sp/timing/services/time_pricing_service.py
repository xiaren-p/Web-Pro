...
from apps.ads.sp.timing.services.time_pricing_calculator import (
    MAX_ERROR_COUNT,
    build_item_map,
    calc_new_bid,
...
def _do_start(
    ...
    """
    from apps.ads.sp.timing.services.time_pricing_calculator import append_start_adjustment
...
def _do_callback(
    ...
    """
    from apps.ads.sp.timing.services.time_pricing_calculator import append_callback_adjustment
