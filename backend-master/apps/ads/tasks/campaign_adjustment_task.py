...
from apps.ads.services.campaign_adjustment_executor import execute_campaign_adjustment
...
@shared_task(
    bind=True,
    name="apps.ads.tasks.campaign_adjustment_task.run_campaign_adjustment_task",
    max_retries=0,
    soft_time_limit=840,
    time_limit=900,
    acks_late=True,
