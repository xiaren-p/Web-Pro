...
from apps.ads.services.ad_optimization.optimization_strategy_service import (
...
@shared_task(
    bind=True,
    name="apps.ads.tasks.optimization_strategy_task.run_optimization_strategy_task",
    max_retries=0,
