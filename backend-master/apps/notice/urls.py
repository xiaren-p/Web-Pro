...
urlpatterns = [
    path("page", NoticeViewSet.as_view({"get": "page"}), name="notice-page"),
    ...
    path("my-page", NoticeViewSet.as_view({"get": "my_page"}), name="notice-my-page"),
    path("export", NoticeViewSet.as_view({"get": "export_data"}), name="notice-export"),
    path("", NoticeViewSet.as_view({"get": "list_or_create", "post": "list_or_create"}), name="notice-list-create"),
