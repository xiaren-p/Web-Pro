...
CELERY_TASK_ROUTES = {
    ...
    'api_v2.tasks.ad_time_pricing_start_task.run_time_pricing_start_task':         {'queue': 'single_thread_queue'},
    'api_v2.tasks.ad_time_pricing_callback_task.run_time_pricing_callback_task': {'queue': 'single_thread_queue'},
